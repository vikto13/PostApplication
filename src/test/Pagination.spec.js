...
describe("Pagination.vue", () => {
    ...
    it("should navigate to previuos page", () => {
        const itemsSize = 32;
    ...
    it("on the last page button is disabled", () => {
        const itemsSize = 7;
        store.getters.pagination.currentPage = 1
    ...
    it("show one pagination button if items are less then given pagine size", () => {
        const itemsSize = 4;
    ...
    it("show five pagination buttons if are a lot of items", () => {
    ...
    it("change button to active when going to next page", async () => {
        const itemsSize = 25;
        const wrapper = shallowMount(Pagination, {
            propsData: { itemsSize },
            store,
